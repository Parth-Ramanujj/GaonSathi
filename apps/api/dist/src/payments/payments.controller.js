...
const razorpay_webhook_dto_1 = require("./dto/razorpay-webhook.dto");
let PaymentsController = class PaymentsController {
    ...
    async razorpayWebhook(payload, signature) {
        return this.paymentsService.verifyPaymentWebhook(payload, signature);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [razorpay_webhook_dto_1.RazorpayWebhookDto, String]),
    __metadata("design:returntype", Promise)
