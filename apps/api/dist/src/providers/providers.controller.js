...
let ProvidersController = class ProvidersController {
    ...
    async getAllListings(categoryId) {
        return this.providersService.getAllListings(categoryId);
    }
    async getProfile(userId) {
        return this.providersService.getProviderProfile(userId);
    }
    async createListing(providerId, data) {
        return this.providersService.createListing(providerId, data);
    }
};
...
], ProvidersController.prototype, "getAllListings", null);
__decorate([
...
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, common_1.Post)(':providerId/listings'),
