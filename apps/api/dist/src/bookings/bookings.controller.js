...
let BookingsController = class BookingsController {
    ...
    async getMyBookings(req, page, limit) {
        return this.bookingsService.getCustomerBookings(req.user.userId, page, limit);
    }
    async updateStatus(id, updateStatusDto) {
        return this.bookingsService.updateBookingStatus(id, updateStatusDto.status);
    }
};
exports.BookingsController = BookingsController;
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(client_1.Role.FARMER, client_1.Role.SHOP_OWNER),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.FARMER, client_1.Role.SERVICE_PROVIDER, client_1.Role.SHOP_OWNER),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.SERVICE_PROVIDER),
