...
export default function ChatInboxPage() {
  const conversations: any[] = []; // Empty state
      ...
      <div style={{ flex: 1, padding: '2rem', maxWidth: '800px', margin: '0 auto', width: '100%' }}>
        ...
        {conversations.length === 0 ? (
          <div className="card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '4rem 2rem', textAlign: 'center' }}>
            ...
            <h2 style={{ color: 'var(--color-soil)', marginBottom: '0.5rem' }}>No active conversations</h2>
            <p style={{ color: 'var(--color-soil)', opacity: 0.8 }}>When you book a service or equipment, your chats will appear here.</p>
          </div>
        ) : (
